...
(function(d){
	...
	b.o=function(){
		...
		this.run=function(){
			...
			this.o);
			this.o.flip=this.o.rotation==="anticlockwise"||this.o.rotation==="acw";if(!this.o.inputColor){
				this.o.inputColor=this.o.fgColor
			}
			if(this.$.is("fieldset")){
				this.v={};
				this.i=this.$.find("input");
				this.i.each(function(g){var h=d(this);
					e.i[g]=h;
			...
			if(!this.c){
				throw {
					name:"CanvasNotSupportedException",message:"Canvas not supported. Please use excanvas on IE8.0.",toString:
					function(){
		...
		this._touch=function(f){
			...
			this.t=b.c.t(f);
			g(f);
			b.c.d.bind("touchmove.k",g).bind("touchend.k",
			function(){
		...
		this._mouse=function(g){
			...
			f(g);
			b.c.d.bind("mousemove.k",f).bind("keyup.k",
			function(h){
				if(h.keyCode===27){
	...
	b.Dial=function(){
		...
		this.val=function(e,f){
			if(null!=e){
				...
				this.v=this.cv;this.$.val(this.o.format(this.v));
				this._draw()
			}
			else{
				return this.v
		...
		this.xy2val=function(e,h){
			var f,g;
			f=Math.atan2(e-(this.x+this.w2),
			-(h-this.y-this.w2))-this.angleOffset;
			if(this.o.flip){
		...
		this.listen=function(){
			var h=this,g,f,l=function(q){
				q.preventDefault();
				var p=q.originalEvent,n=p.detail||p.wheelDeltaX,
		...
		this.init=function(){
			...
			this.o.displayInput&&this.i.css({
				width:((this.w/2+4)>>0)+"px",height:((this.w/3)>>0)+"px",
				position:"absolute",
		...
		this.arc=function(f){
			var e,g;f=this.angle(f);
			if(this.o.flip){
				e=this.endAngle+0.00001;g=e-f-0.00001
			}
			else{
				e=this.startAngle-0.00001;g=e+f+0.00001
			}
		...
		this.draw=function(){
			var h=this.g,
			e=this.arc(this.cv),f,g=1;
			h.lineWidth=this.lineWidth;h.lineCap=this.lineCap;h.strokeStyle=this.o.bgColor;
			h.arc(this.xy,this.xy,this.radius,this.endAngle-0.00001,this.startAngle+0.00001,true);
			h.stroke();
			if(this.o.displayPrevious){
				f=this.arc(this.v);h.beginPath();
