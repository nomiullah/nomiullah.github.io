...
$(".inner-data,.content .departments-criteria ul li .chnage-criteria ul,.select-criteria,.edit-criteria,.left-detail.manage-dep .select-dep-criteria .chnage-criteria ul").mCustomScrollbar({
